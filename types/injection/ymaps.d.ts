declare namespace ymaps {
  ...
  namespace map {
    ...
    class GeoObjects implements IGeoObjectCollection {
      ...
      add(child: IGeoObject | Clusterer, index?: number): this;
      ...
      remove(child: IGeoObject | Clusterer): this;
  ...
  class Clusterer implements IChildOnMap, ICustomizable, IEventEmitter, IParentOnMap {
    ...
    add(child: IGeoObject | IGeoObject[], index?: number): this;
...
// 1
  interface IClustererOptions {
    ...
    clusterIconContentLayout?: IClassConstructor<layout.templateBased.Base>;
    gridSize?: number;
  ...
  interface IMapState {
    ...
    bounds?: number[][];
    center?: number[];
    controls?: (string | control.SearchControl | control.GeolocationControl)[];
  ...
  class Placemark extends GeoObject {
    constructor(geometry: number[] | object | IPointGeometry, properties: object | IDataManager, options?: IPlacemarkOptions | object)
  }
  ...
  function ready(successCallback?: () => any | IReadyobject, errorCallback?: () => any, context?: object): Promise<typeof ymaps>;
  ...
  interface UpdatedIOptionManager extends IOptionManager {
    set(key: string | IGeoObjectOptions, referenceKey?: string): void;
  }

  class UpdatedGeoObjectCollection extends GeoObjectCollection {
    options: UpdatedIOptionManager;
    position: [number, number];
  }

  interface GetGeolocation {
    geoObjects: UpdatedGeoObjectCollection;
  }

	class geolocation {
    static get: () => Promise<GetGeolocation>;
  }
}